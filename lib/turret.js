module.exports = function(servoX, servoZ) {
    ...
    C.onInterval = function(){
        if(C.mode == C.modes.RANDOM) {
            ...
            C._goToPercentage(C.currentPoint.x, C.currentPoint.z);
    ...
    C._goToPercentage = function(xAxisPercentage, zAxisPercentage){
        console.log("                goToPercentage", xAxisPercentage, zAxisPercentage);
